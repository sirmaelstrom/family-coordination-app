...
3. Test successful import:
   ...
   - Paste a recipe URL (try one of these tested sites):
     ...
     - https://www.seriouseats.com/old-fashioned-hot-milk-cake-recipe
   - Click Import
   ...
   - Verify: Recipe image URL imported (check ImagePath field)
...
<success_criteria>
- Import dialog opens from Recipes page
- Recipe import works for tested sites (AllRecipes, BBC Good Food, NYT Cooking, Serious Eats)
- Note: Food Network and Epicurious have aggressive bot protection and won't work
