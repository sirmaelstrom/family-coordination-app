...
namespace FamilyCoordinationApp.Migrations
{
    ...
    [Migration("20260904004151_AddHouseholdCalendarTokens")]
    partial class AddHouseholdCalendarTokens
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyCoordinationApp.Data.Entities.ChoreRoom", b =>
                {
                    b.Property<int>("HouseholdId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("HouseholdId", "ChoreId", "RoomId");

                    b.HasIndex("HouseholdId", "RoomId");

                    b.ToTable("ChoreRooms", (string)null);
                });

            modelBuilder.Entity("FamilyCoordinationApp.Data.Entities.ChoreSnoozeEvent", b =>
                {
                    b.Property<int>("HouseholdId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SnoozeEventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("SnoozeEventId"));
                    ...
                    b.HasKey("HouseholdId", "ChoreId", "SnoozeEventId");

                    b.HasIndex("SetByUserId");

                    b.ToTable("ChoreSnoozeEvents", (string)null);
                });
            ...
            modelBuilder.Entity("FamilyCoordinationApp.Data.Entities.HouseholdCalendarToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FamilyCoordinationApp.Data.Entities.ChoreRoom", b =>
                {
                    b.HasOne("FamilyCoordinationApp.Data.Entities.Chore", null)
                        .WithMany()
                        .HasForeignKey("HouseholdId", "ChoreId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();

                    b.HasOne("FamilyCoordinationApp.Data.Entities.Room", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FamilyCoordinationApp.Data.Entities.ChoreSnoozeEvent", b =>
                {
                    b.HasOne("FamilyCoordinationApp.Data.Entities.User", "SetBy")
                        .WithMany()
