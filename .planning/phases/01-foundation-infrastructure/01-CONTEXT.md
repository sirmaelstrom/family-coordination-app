...
- Phase 1 delivers Docker Compose files only (test locally, deploy to thedarktower in later phase)
...
- Include nginx configuration (provide complete server block for family.heathdev.me)
...
- ZFS paths follow existing thedarktower convention: `/themanjesus/docker-data/family-app/`
