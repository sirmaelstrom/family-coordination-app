...
**Home infrastructure:**
- thedarktower: Ubuntu 24.04 server (Intel i3-4170, 23GB RAM, 10Gbps NIC)
- Domain: *.heathdev.me (via Cloudflare, points to thedarktower)
...
- **Deployment**: Must run on thedarktower (Ubuntu 24.04) via Docker Compose, accessible at family.heathdev.me
...
| PostgreSQL over SQL Server | Linux deployment target (thedarktower is Ubuntu), open source, Docker-friendly, sufficient for single-tenant scale | — Pending |
