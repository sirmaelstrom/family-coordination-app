...
| 5 | Application runs on thedarktower via Docker Compose accessible at family.heathdev.me | ? UNCERTAIN | Docker files complete, nginx configured for domain, needs human deployment test |
